  ...
  return (
    <div >
      <div className="container state-overview ">
                    ...
                    <div className='icon'><i class='bx bx-phone-call'></i></div>
					            <div className="info-box-content">
					              <span className="info-box-text">Products</span><br></br>
                    ...
                    <div className='icon'><i class='bx bxs-plane-alt'></i></div>
					            <div className="info-box-content">
					              <span className="info-box-text">Total Product On Order</span><br></br>
                    ...
                    <div className='icon'><i class='bx bx-dollar-circle'></i></div>
					            <div className="info-box-content">
					              <span className="info-box-text">Total Earning</span><br></br>
